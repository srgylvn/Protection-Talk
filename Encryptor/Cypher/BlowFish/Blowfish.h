...
{
public:
	void DecryptBuffer(unsigned char* pIn, unsigned int iSize, unsigned char** ppOut, unsigned int &iOutSize);
	void EncryptBuffer(unsigned char* pIn, unsigned int in_size, unsigned char** ppOut, unsigned int & out_size);
...
private:
	unsigned int GetOutputArraySize(unsigned int input_array_size);
